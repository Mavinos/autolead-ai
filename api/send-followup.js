...
module.exports = async function handler(req, res) {
  ...
  let htmlBody = `<p>Bonjour ${name},</p><p>Je reviens vers vous concernant votre demande${company ? ` pour <b>${company}</b>` : ""}.</p><p>Est-ce toujours d'actualité ?</p><p>À très vite,<br>L'équipe AutoLead AI</p>`;
...
Rédige un email court (4 à 6 phrases maximum) qui fait référence concrètement à ce que le prospect a demandé (s'il a précisé quelque chose), pas un message générique. Signe "L'équipe AutoLead AI".
